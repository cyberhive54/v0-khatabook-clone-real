      ...
      <div className="flex-1">
        ...
        <main className="p-4 md:p-6 lg:p-8 max-w-4xl mx-auto w-full">
          ...
          <Tabs defaultValue="profile" className="w-full">
            ...
            <div className="border-t border-border pt-6 mt-6">
              <h2 className="text-lg font-semibold text-foreground mb-4">Sync & Data Management</h2>
              <p className="text-sm text-muted-foreground mb-4">
                Your data automatically syncs every 1 minute. View detailed sync logs from the sync status indicator in the header (eye icon).
              </p>
              <div className="flex items-center gap-3 p-3 rounded-lg bg-blue-50 border border-blue-200">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-blue-900">Offline-First Architecture</p>
                  <p className="text-xs text-blue-700">All data is stored locally and synced automatically. You can work offline, and changes will sync when you're back online.</p>
                </div>
              </div>
            </div>
